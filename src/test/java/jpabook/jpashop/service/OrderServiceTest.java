...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        goods goods = createBook("시골 JPA", 10000, 10);

        int orderCount = 2;

        //when
        Long orderId = orderService.order(member.getId(), goods.getId(), orderCount);
        ...
        assertEquals("주문 수량만큼 재고가 줄어야 한다.", 8, goods.getStockQuantity());
    }
    ...
    public void 주문취소() throws Exception {
        //given
        Member member = createMember();
        goods item = createBook("시골 JPA", 10000, 10);
